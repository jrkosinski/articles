...
Finally, *automated tools* can give you a huge amount of help in testing. [Slither](https://github.com/crytic/slither), [Manticore](https://github.com/trailofbits/manticore), and [Mythril](https://github.com/ConsenSys/mythril) are industry standards, typically used by the major names in security auditing like Consensys and Certik. [Solidity-coverage](https://www.npmjs.com/package/solidity-coverage) (a nodejs package) will tell you the estimated percentages of coverage your unit tests are providing (very handy as a rule of thumb). [Solgraph](https://github.com/raineorshine/solgraph) is a tool that can help you see relationships and connections in contract code; useful in test planning. [Echidna](https://github.com/crytic/echidna) is useful too; it’s a fuzzing test tool. Personally I use a test-first methodology where applicable. This ensures good test coverage, and the test suite becomes similar to a project spec. I love me some good test coverage.
